...
try {
    ...
    $stmt = $conn->prepare("SELECT email, CONCAT(nombres, ' ', primer_apellido) AS nombre_completo, estatus FROM admin");
    $stmt->execute();
    ...
    <body>
        <main>
            <div class="admin-container">
                <div class="header">
                    <p class="title">Administradores BabyChat</p>
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            <div class='button-container'>
                                                <div class='ver'>
                                                    <a class='verr' href='admin_vista.php?email=" . $row['email'] . "'><button>Ver</button></a>
                                                </div>
                                                <div class='editar'>
                                                    <a class='editarr' href='admin_editar.php?email=" . $row['email'] . "'><button class='edit'>Editar</button></a>
                                                </div>
                                                <div class='nuevo'>
                                                    <a class='nuevoo' href='admin_estatus.php?email=" . $row['email'] . "'><button class='status'>Estatus</button></a>
                                                </div>
                                                <div class='delete'>
                                                    <a class='deletee' href='admin_eliminar.php?email=" . $row['email'] . "'><button class='delete'>Eliminar</button></a>
                                                </div>
                                            </div>
                                        </td>";
                                    echo "</tr>";
