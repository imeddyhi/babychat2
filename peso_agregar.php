...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query_insertar = "INSERT INTO seguimiento_peso (id_bebe, peso, fecha) VALUES (?, ?, ?)";
    $stmt_insertar = $conn->prepare($query_insertar);
    $stmt_insertar->bind_param('ids', $id_bebe, $peso, $fecha);
    $stmt_insertar->execute();

    // Redireccionar para evitar reenvío del formulario
    header("Location: seguimiento_peso.php?id_bebe=" . $id_bebe);
    exit();
}
?>
...
<head>
    ...
    <title>Agregar Peso del Bebé</title>
    <style>
        body {
