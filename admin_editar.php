...
try {
    ...
    $stmt = $conn->prepare("SELECT email, nombres, primer_apellido, segundo_apellido, fecha_nacimiento, genero, estatus, fecha_registro FROM admin WHERE email = ?");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $updateStmt = $conn->prepare("UPDATE admin SET nombres = ?, primer_apellido = ?, segundo_apellido = ?, fecha_nacimiento = ?, genero = ? WHERE email = ?");
